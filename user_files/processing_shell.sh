...
then
	...
	do
		...
		sh /home/despoC/scookson/Desktop/tutorialScripts/permanent/AFNI_PROC.sh $subject $studySuffix "$blocksDesired" "$runPrefix" "$acqSeq" $blur "$regressorNames" "${contrasts[@]}"
